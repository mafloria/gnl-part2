    ...
    <div class="landscape-top">
     <!--elementos landscape top 1 --> 
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-1500'  data-sequence='300'>
         ...
         <div class="group-animated animatedParent"  data-appear-left-offset='-2800'  data-sequence='300'>
    ...
    <!--CAMION -->
     <div class="landscape-bottom">
         ...
         <div class="group-animated animatedParent" data-appear-left-offset='500'  data-sequence='100'>
             ...
             <h3 id="h3-0" class="title-green absolute animated fadeInLeftShort" data-id="3"><?php echo $texts->gasoducto->road_info->red_distribucion; ?></h3>
         </div>

        <!--elementos landscape bottom 2 --> 
        <div class="group-animated animatedParent"  data-appear-left-offset='-2500'  data-sequence='300'>
            <h3 id="h3-1" class="title-green absolute animated fadeInLeftShort" data-id="1"><?php echo $texts->gasoducto->road_info->gas_natural; ?></h3>
            <div id="arrow-0" class="red-arrow absolute animated fadeInLeftShort" data-id="2"></div>
            <h3 id="h3-01" class="title-green absolute animated fadeInLeftShort" data-id="3"><?php echo $texts->gasoducto->road_info->red_distribucion; ?></h3>
            ...
            <h3 id="h3-02" class="title-green absolute animated fadeInLeftShort" data-id="6"><?php echo $texts->gasoducto->road_info->gas_limpio; ?></h3>
        ...
        <!--elementos landscape bottom 3 -->                     
         <div class="group-animated animatedParent"  data-appear-left-offset='-4000'  data-sequence='300'>
            <h3 id="h3-03" class="title-green absolute animated fadeInLeftShort" data-id="1"><?php echo $texts->gasoducto->road_info->gas_limpio; ?></h3>
            <div id="arrow-2" class="red-arrow absolute animated fadeInLeftShort" data-id="2"></div>
             ...
             <h3 id="h3-04" class="title-green absolute animated fadeInLeftShort" data-id="7"><?php echo $texts->gasoducto->road_info->gas_licuado; ?></h3>
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-15800'  data-sequence='200'>
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-17000'  data-sequence='200'>            
            ...
            <h3 id="h3-29" class="title-h3 absolute animated fadeInUpShort" data-id="13"><?php echo $texts->gasoducto->road_info->ahorro_desc; ?></h3>
        </div>
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-18000'  data-sequence='300'>
            ...
            <h4 id="subt-12" class="subtitle animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->road_info->monetice_desc; ?></h4>
        </div>
