    ...
    <div class="landscape-top">
     <!--elementos landscape top 1 --> 
         ...
         <div class="group-animated animatedParent" data-appear-left-offset='-6400'  data-sequence='300'>
            <h2 id="h2-4" class="h2-title-box animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->top_titles->gasoducto_virtual; ?></h2>
            <h4 id="subt-4" class="subtitle animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->top_titles->gasoducto_virtual_desc; ?></h4>
         </div>


        <div class="group-animated animatedParent" data-appear-left-offset='-7200'  data-sequence='300'>
            <h2 id="h2-5" class="h2-title-box animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->top_titles->estacion_hija; ?></h2>
            <h4 id="subt-5" class="subtitle animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->top_titles->estacion_hija_desc; ?></h4>
            <h3 id="h3-3" class="title-h3 absolute animated fadeInLeftShort" data-id="3"><?php echo $texts->biogas->top_titles->estacion_hija_desc2; ?></h3>
        </div>
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-9200'  data-sequence='300'>
            ...
            <h4 id="subt-6" class="subtitle animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->top_titles->estacion_hija_desc; ?></h4>
            <h3 id="h3-10" class="title-h3 absolute animated fadeInLeftShort" data-id="3"><?php echo $texts->biogas->top_titles->estacion_hija_desc2; ?></h3>
        </div>
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-10600'  data-sequence='300'>
            ...
            <h4 id="subt-7" class="subtitle animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->top_titles->estacion_hija_patagonia; ?></h4>
        </div> 

        <!--elementos landscape top 8 -->
        <div class="group-animated animatedParent" data-appear-left-offset='-11800'  data-sequence='300'>
            <h2 id="h2-8" class="h2-title-box animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->top_titles->estacion_hija; ?></h2>
            <h4 id="subt-8" class="subtitle animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->top_titles->estacion_hija_patagonia; ?></h4>
        </div> 

        <!--elementos landscape top 9 -->
        <div class="group-animated animatedParent" data-appear-left-offset='-12900'  data-sequence='300'>
            <h2 id="h2-9" class="h2-title-box animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->top_titles->estacion_hija; ?></h2>
            <h4 id="subt-9" class="subtitle animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->top_titles->estacion_hija_patagonia; ?></h4>
        </div> 

         <!--elementos landscape top 10 -->
        <div class="group-animated animatedParent" data-appear-left-offset='-14100'  data-sequence='300'>
            <h2 id="h2-10" class="h2-title-box animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->top_titles->estacion_hija; ?></h2>
            <h4 id="subt-10" class="subtitle animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->top_titles->estacion_hija_desc; ?></h4>
        </div> 

        <!--elementos landscape top 11 -->
        <div class="group-animated animatedParent" data-appear-left-offset='-15700'  data-sequence='300'>
            <h2 id="h2-11" class="h2-title-box animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->top_titles->estacion_hija; ?></h2>
            <h4 id="subt-11" class="subtitle animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->top_titles->estacion_hija_desc; ?></h4>
        </div> 
    ...
    <!--CAMION -->
     <div class="landscape-bottom">
         ...
         <div class="group-animated animatedParent" data-appear-left-offset='-200'  data-sequence='100'>
             ...
             <p id="icon-txt-1" class="txt-box1 animated fadeInLeftShort" data-id="3"><?php echo $texts->biogas->process->fuentes_biogas_box_op1; ?></p>

             <div id="icon-2" class="icon2 absolute animated fadeInLeftShort" data-id="4"></div> 
             <p id="icon-txt-2" class="txt-box1 animated fadeInLeftShort" data-id="5"><?php echo $texts->biogas->process->fuentes_biogas_box_op2; ?></p> 

             <div id="icon-3" class="icon3 absolute animated fadeInLeftShort" data-id="6"></div> 
             <p id="icon-txt-3" class="txt-box1 animated fadeInLeftShort" data-id="7"><?php echo $texts->biogas->process->fuentes_biogas_box_op3; ?></p>
         </div>

         <div class="group-animated animatedParent" data-appear-left-offset='-200'  data-sequence='100'>
            <div id="icon-4" class="icon4 absolute animated fadeInLeftShort" data-id="1"></div> 
             <p id="icon-txt-4" class="txt-box1 animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->process->fuentes_biogas_box_op4; ?></p>

             <div id="icon-5" class="icon5 absolute animated fadeInLeftShort" data-id="3"></div> 
             <p id="icon-txt-5" class="txt-box1 animated fadeInLeftShort" data-id="4"><?php echo $texts->biogas->process->fuentes_biogas_box_op5; ?></p>

             <div id="icon-6" class="icon6 absolute animated fadeInLeftShort" data-id="5"></div> 
             <p id="icon-txt-6" class="txt-box1 animated fadeInLeftShort" data-id="6"><?php echo $texts->biogas->process->fuentes_biogas_box_op6; ?></p>

             <div id="line-1" class="linea-txt-1 absolute animated fadeInLeftShort" data-id="7"></div>
             <p id="txt-1" class="txtInfo animated fadeInLeftShort" data-id="8"><?php echo $texts->biogas->process->fuentes_biogas_desc; ?></p>
         </div>
        ...
        <div class="group-animated animatedParent"  data-appear-left-offset='-2900'  data-sequence='300'>
            <h3 id="h3-5" class="title-h3 animated absolute fadeInLeftShort" data-id="1"><?php echo $texts->biogas->process->p1_criobox_bio; ?></h3>
            <p id="txt-2" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->process->p1_criobox_bio_desc; ?></p>
            <p id="txt-3" class="txtInfo animated fadeInLeftShort" data-id="3"><?php echo $texts->biogas->process->p1_criobox_bio_desc2; ?>
                <br /><br />
            <?php echo $texts->biogas->alert_messages->a1_criobox_bio; ?></p>
        ...
        <!--elementos landscape bottom 3 -->                     
         <div class="group-animated animatedParent"  data-appear-left-offset='-4750'  data-sequence='300'>
             <h3 id="h3-7" class="title-h3 absolute animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->process->p2_almacenamiento; ?></h3>
             <p id="txt-4" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->process->p2_almacenamiento_desc; ?></p>
             <p id="txt-5" class="txtInfo animated fadeInLeftShort" data-id="3"><?php echo $texts->biogas->alert_messages->a2_almacenamiento; ?></p>
        ...
        <!--elementos landscape bottom 4 -->
         <div class="group-animated animatedParent"  data-appear-left-offset='-6500'  data-sequence='300'>
             <p id="txt-6" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->process->p3_transporte_sintuberias_desc; ?></p>
         </div>
        ...
        <div class="group-animated animatedParent"  data-appear-left-offset='-7500'  data-sequence='300'>
             ...
             <h3 id="h3-8" class="title-h3-s absolute animated fadeInLeftShort" data-id="6"><?php echo $texts->biogas->road_info->usinas; ?></h3>
        </div>
        ...
        <div class="group-animated animatedParent"  data-appear-left-offset='-7700'  data-sequence='300'>
             ...
             <h3 id="h3-9" class="title-h3-s absolute animated fadeInLeftShort" data-id="4"><?php echo $texts->biogas->road_info->industrias; ?></h3>
        </div>
        ...
        <div class="group-animated animatedParent"  data-appear-left-offset='-9400'  data-sequence='300'>
            <div id="blt-3" class="blue-line-title absolute animated fadeInLeftShort" data-id="1"></div>
             <h3 id="h3-11" class="title-h3-s absolute animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->road_info->transporte; ?></h3>
        </div>
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-10500'  data-sequence='200'>
            <h3 id="h3-13" class="title-h3 absolute animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->process->p4_estacion_patagonia; ?></h3> 
            <p id="txt-7" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->process->p4_estacion_patagonia_desc; ?></p>   
        </div>
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-12000'  data-sequence='200'>
            ...
            <p id="txt-10" class="txtInfo animated fadeInLeftShort" data-id="3"><?php echo $texts->biogas->road_info->bio_gnc; ?></p>  
            <p id="txt-11" class="txtInfo animated fadeInLeftShort" data-id="4"><?php echo $texts->biogas->road_info->bio_gnl; ?></p>       
        </div>

        <div class="group-animated animatedParent" data-appear-left-offset='-12000'  data-sequence='200'>
            <p id="txt-8" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->process->p5_biognc_desc; ?></p> 
            <p id="txt-9" class="txtInfo animated fadeInLeftShort" data-id="4"><?php echo $texts->biogas->process->p6_biognl_desc; ?></p>   
        </div>
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-13100'  data-sequence='200'>
         ...
         <div class="group-animated animatedParent" data-appear-left-offset='-13200'  data-sequence='200'>
            <p id="txt-12" class="txtInfo animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->alert_messages->a3_suministro_continuo_desc; ?></p>  
            <h3 id="h3-16" class="title-h3 absolute animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->alert_messages->a3_suministro_continuo_titulo; ?></h3>
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-13300'  data-sequence='200'>
            <p id="txt-13" class="txtInfo animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->process->p7_centro_logistico_desc; ?></p>  
            <p id="txt-14" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->alert_messages->a4_nivel_abastecimiento_desc; ?></p> 
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-13900'  data-sequence='200'>
            <h3 id="h3-17" class="title-h3 absolute animated fadeInLeftShort" data-id="1"><?php echo $texts->biogas->road_info->gas_natural_para; ?></h3>
            ...
            <h3 id="h3-18" class="title-h3-s absolute animated fadeInLeftShort" data-id="5"><?php echo $texts->biogas->road_info->comunidades_aisladas; ?></h3>
            ...
            <h3 id="h3-19" class="title-h3-s absolute animated fadeInLeftShort" data-id="9"><?php echo $texts->biogas->road_info->inyeccion_red; ?></h3>
            ...
            <h3 id="h3-20" class="title-h3-s absolute animated fadeInLeftShort" data-id="13"><?php echo $texts->biogas->road_info->terminales_recepcion; ?></h3>
        </div>

        <!--elementos landscape bottom 10 -->
        <div class="group-animated animatedParent" data-appear-left-offset='-15700'  data-sequence='300'>
            <div id="b-line-8" class="b-line-8 absolute animated fadeInLeftShort" data-id="1"></div>
            <h3 id="h3-21" class="title-h3-s absolute animated fadeInLeftShort" data-id="2"><?php echo $texts->biogas->road_info->terminales_recepcion; ?></h3>
        ...
        <div class="group-animated animatedParent" data-appear-left-offset='-17400'  data-sequence='200'>
            ...
            <h3 id="h3-22" class="title-h3 absolute animated fadeInDownShort" data-id="3"><?php echo $texts->biogas->process->p8_gnl_limpio_co2; ?></h3>
            <div id="figure-21" class="figure16 absolute animated fadeInDownShort" data-id="4"></div> 
            <h3 id="h3-23" class="title-h3 absolute animated fadeInDownShort" data-id="5"><?php echo $texts->biogas->process->p8_gnl_limpio_nox; ?></h3>
            <div id="figure-22" class="figure16 absolute animated fadeInDownShort" data-id="6"></div>
            <h3 id="h3-24" class="title-h3 absolute animated fadeInDownShort" data-id="7"><?php echo $texts->biogas->process->p8_gnl_limpio_particulado; ?></h3> 
            <div id="figure-23" class="figure16 absolute animated fadeInDownShort" data-id="8"></div> 
            <h3 id="h3-25" class="title-h3 absolute animated fadeInDownShort" data-id="9"><?php echo $texts->biogas->process->p8_gnl_limpio_gei; ?></h3>             

            <div id="figure-24" class="figure15 absolute animated fadeInUpShort" data-id="11"></div> 
            <h3 id="h3-27" class="title-h3 absolute animated fadeInUpShort" data-id="12"><?php echo $texts->biogas->road_info->ahorro; ?></h3> 
        </div>
